...
//  Copyright (c) 2014 Hakan Sivritepe. All rights reserved.
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( indexPath.section == 1 ) {
        ...
        cell.textLabel.text = @"SECTION 2 IT IS";
    }else {
        cell.textLabel.text = [NSString stringWithFormat:@"we are in cell %i",indexPath.row];
    }
